const games = [
    // --- MULTIPLAYER & SANDBOX ---
    {
        ...
        external: true // Abre seguro em aba dedicada
    },
    {
        title: "MineFun.io",
        category: "obby",
    ...
    },
    {
        ...
        url: "https://www.gameflare.com/embed/soccer-skills-euro-cup/",
        external: false
    },
    ...
    // --- OBBY & 3D ---
    {
        ...
        url: "https://www.gameflare.com/embed/noob-parkour-obby/",
        external: false
    },
    {
        ...
        category: "obby",
        image: "https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=400",
        url: "https://www.gameflare.com/embed/block-craft/",
        external: false
    },
    {
        title: "Level Devil",
        ...
        url: "https://www.gameflare.com/embed/level-devil/",
        external: false
    },
    ...
    // --- PUZZLE & TROLL ---
    {
        ...
        url: "https://www.gameflare.com/embed/brain-test/",
        external: false
    },
    {
        title: "2048 Classic",
    ...
    // --- AÇÃO / RUNNER ---
    {
        ...
        category: "acao",
        image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=400",
        url: "https://www.gameflare.com/embed/subway-surfers/",
        external: false
    },
    {
        title: "Moto X3M",
...
function displayGames(gamesToDisplay) {
    ...
    gamesToDisplay.forEach(game => {
        ...
        // Direciona corretamente se abre em player interno ou aba externa segura
        if (game.external) {
            card.href = game.url;
            card.target = "_blank";
        } else {
